...
def get_user_config(existing_config: UserConfig):
    user_config = UserConfig(
        LLM=existing_config.LLM or os.getenv("LLM") or LLM.OPENAI,
        OPENAI_API_KEY=existing_config.OPENAI_API_KEY or get_openai_api_key_env(),
        OPENAI_MODEL=existing_config.OPENAI_MODEL or os.getenv("OPENAI_MODEL"),
        GOOGLE_API_KEY=existing_config.GOOGLE_API_KEY or os.getenv("GOOGLE_API_KEY"),
        GOOGLE_MODEL=existing_config.GOOGLE_MODEL or os.getenv("GOOGLE_MODEL"),
        ANTHROPIC_API_KEY=existing_config.ANTHROPIC_API_KEY
        or os.getenv("ANTHROPIC_API_KEY"),
        ANTHROPIC_MODEL=existing_config.ANTHROPIC_MODEL
...
def update_env_with_user_config(user_config: UserConfig):
    if user_config.LLM:
        set_llm_env(user_config.LLM)
