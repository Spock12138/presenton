...
export const layoutId = 'zjut-opening-table-of-contents-slide'
export const layoutName = 'ZJUT Opening Report Contents'
export const layoutDescription = '浙江工业大学开题报告目录页，展示标准四章节结构：选题背景、研究现状、研究内容、进度安排。'
...
const TableOfContentsSlideLayout: React.FC<TableOfContentsSlideLayoutProps> = ({ data: slideData }) => {
    // 使用硬编码的开题报告标准章节，忽略用户输入的 sections
            ...
            <div className="flex flex-col h-full px-4 sm:px-8 lg:px-12 py-2">
                ...
                <div className="text-center mb-6">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-3">
                        <div 
                            ...
                            style={{ backgroundColor: ZJUT_PRIMARY_COLOR, opacity: 0.3 }}
                        />
                        <div 
                    ...
                    {sections.map((section, index) => (
                        <div 
                            ...
                            style={{
                                ...
                                boxShadow: '0 2px 8px rgba(30, 78, 121, 0.08)',
                            }}
                        >
                            {/* 序号徽章 */}
                            <div 
                            ...
                            <div 
                                ...
                                style={{
                                    width: 0,
                                    height: 0,
                                    borderTop: `24px solid ${ZJUT_GOLD_ACCENT}`,
                ...
                <div className="flex justify-center mt-4">
                    <div className="flex items-center gap-3">
                        <div 
                            className="w-6 h-px"
                            style={{ backgroundColor: ZJUT_PRIMARY_COLOR, opacity: 0.4 }}
                        />
                        <div 
                        ...
                        <span 
                            ...
                            style={{ color: 'rgba(30, 78, 121, 0.5)' }}
                        >
                            ZJUT · 开题报告
                        </span>
                        <div 
