...
export const layoutId = 'zjut-opening-intro-slide'
export const layoutName = 'ZJUT Opening Report Cover'
export const layoutDescription = '浙江工业大学开题报告封面页，包含论文标题、学生信息、指导教师等关键信息。'
...
const introSlideSchema = z.object({
    title: z.string().min(3).max(120).default('基于深度学习的智能系统研究与实现').meta({
        description: "论文/研究主标题",
    }),
    subtitle: z.string().max(150).optional().default('').meta({
        description: "副标题（可选）",
    }),
    studentName: z.string().min(2).max(50).default('王小明').meta({
        description: "学生姓名",
    }),
    studentId: z.string().max(30).optional().default('202312345678').meta({
        description: "学号（可选）",
    }),
    supervisorName: z.string().max(50).default('张教授').meta({
        description: "指导教师姓名",
    }),
    ...
    return (
        ...
        >
            ...
            <div 
                ...
                style={{
                    background: `linear-gradient(160deg, rgba(30, 78, 121, 0.88) 0%, rgba(30, 78, 121, 0.75) 50%, rgba(20, 50, 80, 0.9) 100%)`,
                }}
            />
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-16 pt-24 pb-40">
                ...
                <div 
                    ...
                    style={{ 
                        ...
                        border: `1px solid ${ZJUT_GOLD_ACCENT}`,
                    }}
                >
                    <span 
                ...
                <div className="flex items-center gap-3 mt-2">
                    <div className="w-12 h-px" style={{ backgroundColor: ZJUT_GOLD_ACCENT, opacity: 0.6 }} />
                    <div className="w-2 h-2 rounded-full" style={{ backgroundColor: ZJUT_GOLD_ACCENT }} />
                    <div className="w-12 h-px" style={{ backgroundColor: ZJUT_GOLD_ACCENT, opacity: 0.6 }} />
                </div>
            </div>
            ...
            <div 
                ...
                style={{
                    background: 'linear-gradient(to top, rgba(10, 30, 50, 0.95) 0%, rgba(20, 50, 80, 0.9) 100%)',
                    borderTop: `2px solid ${ZJUT_GOLD_ACCENT}`,
                }}
            >
            ...
            <div 
                ...
                style={{
                    borderTop: `3px solid ${ZJUT_GOLD_ACCENT}`,
                    borderLeft: `3px solid ${ZJUT_GOLD_ACCENT}`,
                    opacity: 0.5,
                }}
            />
            <div 
                ...
                style={{
                    borderTop: `3px solid ${ZJUT_GOLD_ACCENT}`,
                    borderRight: `3px solid ${ZJUT_GOLD_ACCENT}`,
                    opacity: 0.5,
                }}
            />
        </div>
