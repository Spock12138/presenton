...
export const layoutId = 'zust-opening-numbered-bullets-slide'
export const layoutName = 'ZUST Numbered Points'
export const layoutDescription = '浙科大开题报告编号要点页面，适用于展示研究步骤、实验方法等有序内容。'
                ...
                <div className="flex-1 space-y-4 overflow-y-auto">
                    {bulletPoints.map((bullet, index) => (
                        ...
                        >
                            ...
                            {/* Decorative corner - 使用浙科大橙色 */}
                            <div 
                                className="w-0 h-0 mt-1"
                                style={{
                                    borderTop: `8px solid ${ZUST_ORANGE_ACCENT}`,
