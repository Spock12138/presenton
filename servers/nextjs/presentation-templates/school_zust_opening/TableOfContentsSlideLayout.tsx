...
export const layoutId = 'zust-opening-table-of-contents-slide'
export const layoutName = 'ZUST Opening Report Contents'
export const layoutDescription = '浙江科技大学开题报告目录页，展示标准四章节结构。'
            ...
            <div className="flex flex-col h-full px-4 sm:px-8 lg:px-12 py-2">
                ...
                <div className="text-center mb-6">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-3">
                        <div 
                            ...
                            style={{ backgroundColor: ZUST_PRIMARY_COLOR, opacity: 0.3 }}
                        />
                        <div 
                    ...
                    {sections.map((section, index) => (
                        <div 
                            ...
                            style={{
                                ...
                                boxShadow: '0 2px 8px rgba(0, 75, 135, 0.08)',
                            }}
                        >
                            {/* 序号徽章 */}
                            <div 
                            ...
                            <div 
                                ...
                                style={{
                                    width: 0,
                                    height: 0,
                                    borderTop: `24px solid ${ZUST_ORANGE_ACCENT}`,
                ...
                <div className="flex justify-center mt-4">
                    <div className="flex items-center gap-3">
                        <div 
                            className="w-6 h-px"
                            style={{ backgroundColor: ZUST_PRIMARY_COLOR, opacity: 0.4 }}
                        />
                        <div 
