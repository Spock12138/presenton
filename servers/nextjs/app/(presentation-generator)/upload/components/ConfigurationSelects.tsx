        ...
        <DialogContent className="max-w-2xl font-instrument_sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="w-full flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-700">风格基调</label>
              <p className="text-xs text-gray-500">控制写作风格（如：休闲、专业、趣味）</p>
              <Select
            ...
            {/* Verbosity */}
            <div className="w-full flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-700">详略程度</label>
